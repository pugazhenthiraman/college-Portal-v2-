  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <select value={selectedState} onChange={handleStateChange} className="block w-full border rounded-lg">
      ...
      <div>
        ...
        <select value={selectedDistrict} onChange={handleDistrictChange} className="block w-full border rounded-lg" disabled={!selectedState}>
      ...
      <div>
        ...
        <select onChange={handlePlaceChange} className="block w-full border rounded-lg" disabled={!selectedDistrict}>
